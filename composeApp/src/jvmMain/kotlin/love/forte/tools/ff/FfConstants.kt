 ...
 */
object FfConstants {
    const val MARKER_FILE_NAME: String = ".ff"

    /**
     * 用于表示“无扩展名”的内部标识；写入 .ff 时也使用该值。
     */
    const val EXTENSION_NONE: String = "<none>"
     ...
     */
    @JvmField
    val NAMING_VERSION: FfNamingVersion = FfNamingVersion.V3
     ...
     */
    const val MAX_LINK_CONCURRENCY: Int = 64

    /**
     * 进度上报节流：降低 UI 状态更新频率，避免频繁重组导致卡顿。
     */
    const val PROGRESS_EMIT_INTERVAL_MS: Long = 200
}
